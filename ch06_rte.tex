...
In Recognizing Textual Entailment, a system is provided two sentences, a text (antecdent) and
...
short phrases for which it needs lexical entailment judgements. This alignment
...
from work in previous chapters, which never attempted to identify contraditions
