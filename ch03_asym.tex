...
and all work in this chapter constitutes original contributions.
...
in each particular train/test setup, as shown in the Discarded section of
...
\begin{table}
  ...
  \begin{tabular}{|l|c|c|c|}
      \hline
      {\bf Stratification} & {\bf Training Examples} & {\bf W/ overlap} & {\bf W/o overlap} \\
      \hline
      \hline
      Random               &     13,464             &   .976           &     -             \\
...
\begin{table}
  ...
  \begin{tabular}{|l|cccc|cccc|}
    \hline
    & \multicolumn{4}{c|}{{\bf Original Space}} & \multicolumn{4}{c|}{{\bf Selective Space}}\\
    \hline\hline
    \begin{maybetiny}Measure        \end{maybetiny}&
    \begin{maybetiny}Co-hyp  \end{maybetiny}&
