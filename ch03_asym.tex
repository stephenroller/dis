...
and \lit{animals including cats}. Each of these provides evidence that X is a
...
data set is somewhat small, it is often common to evaluate using
...
unfortunately, category information is only available in one data set, making
it difficult to test robustness of models across multiple data sets.
