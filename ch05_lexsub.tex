...
providing suggestions. In one dataset, humans provided with the context
\begin{quote}
...
\newcite{levy:2014:acl}. As with many other unsupervised models, it combines a
...
exception of \lit{realy}. This suggests that our model may be predicting terms
with a higher unigram frequency.

Table~\ref{tab:lemon} shows a lemon-picked example, where our model performs
worse than other cases.  We notice that the unusual \lit{sea-change} item is
