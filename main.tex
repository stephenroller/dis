...
Lexical Entailment can be broadly defined as any number of ``semantic relations
that hold between lexical elements when the meaning of one element can be
inferred from the meaning of the other'' \cite{shnarch:2008:thesis}. This
can include many classical lexical relations, like hypernymy
(a girl {\em is a} child; a dog {\em is an} animal), and meronomy
(a girl {\em has} eyes; a dog {\em has a} tail). It can also include a
