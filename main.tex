...
relationship data sets, we should also show that it can improve performance
...
neutral (neither of the above). Two examples from the data set are shown
...
to train a lexical entailment classifier, which we call {\bf RRR} (RTE by
Robinson Resolution).
