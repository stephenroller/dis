...
Interestingly, this vector subtraction approach reasonably models both
grammatical relationships (singular/plural, verb conjugations) and some
semantic relationships (gender, capital/country).
