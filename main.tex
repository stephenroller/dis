...
Context can be also defined as {\em syntactic neighbors} \cite{pado:2007:cl},
as demonstrated in Figure~\ref{fig:syn}.

\begin{figure}
  \includegraphics[width=0.7\textwidth]{figures/syn}
\caption{Example of a dependency parse for ``The dog chased its tail.''}
\label{fig:syn}
\end{figure}
