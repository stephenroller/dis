...
finding specific synonyms for words {\em in a given sentential context}.
That is, we wish to also consider how polysemy can change some of the
lexical entailments we can derive from a system.
...
called {\em polysemy}, and is a major issue in distributional semantics, since
word meaning is typically modeled as single point estimates
\newcite{turney:2010:jair,erk:2012:llc}.
