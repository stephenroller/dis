...
\begin{equation}
  ...
  \label{eqn:pic}
\end{equation}
Our model differs from {\em balAddCos} one major way: we base our similarity
...
parameters, $W$ and $b$, which act as a simple linear transformation over
...
which act as a linear transformation over the context vectors.
