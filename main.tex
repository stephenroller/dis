...
First, we consider one important parameter which differed between the original
Asym experiments and the RTE experiments: in the former, we only used
distributional spaces based on BoW features, in in the latter, we
used both BoW and syntactic distributional spaces.
