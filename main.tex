...
hypernymy prediction is actually one aspect of predicting the full ontology.

However, as discussed in the short term proposals,
hypernymy prediction is not the only important word relationship that could
be predicted from distributional information. Indeed, if we posit that the
non-hypernymy relations can be predicted from even moderate accuracy,
then the additional information provided could 
