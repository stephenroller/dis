...
we show how these H-features can be improved using an iterative procedure similar
...
Asym and Ksim. To this end, we propose a novel model which exploits the
...
\begin{tabular}{|l|rrrr|}
  ...
  H-Feature Detector &{\bf.901}  &  {\bf.631}  &  {\bf.260}    &      .697   \\
  \hline
\end{tabular}
\end{small}
