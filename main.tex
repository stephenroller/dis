...
That is, for a pair of words in the SICK data set, measure the similarity of their
contexts using the $P(s|C)$ or $P_n(s|C)$ values proposed in Equation~\ref{eqn:pic}
and Equation~\ref{eqn:npic}.

Ultimately though, we suspect improvements to RTE from our Lexical Substitution
model may be marginal, or even negative, as polysemy is not common in the
primary RTE data set that we use.
