...
progress has been made in many areas of research, like Part-of-Speech tagging
\cite{toutanova:2003:naacl} and Parsing \cite{chen:2014:emnlp}.  Significant
progress has also been made even in some very difficult semantics tasks, like
Named Entity Recognition \cite{lample:2016:naacl}, Sentiment Analysis
...
RTE is a very difficult task, at least partially due to its extreme breadth.
Entailments may require extensive common sense knowledge or highly specialized
domain specific knowledge; it may require sophisticated logical reasoning
about quantifiers, set membership, and implication; or it may require a more
graded, fuzzier reasoning about related words. Ultimately though, all RTE
systems must be able to reason about specific lexical items and lexical
relationships, like hypernymy or synonymy.
