...
\begin{abstract}
  ...
  inference between sentences, but depend heavily on lexical resources like
  WordNet to provide critical information like the relationships between
  lexical items, or whether one lexical item entails another. However, lexical
  resources are expensive to create and maintain, and are never be
  comprehensive.
...
models perform better. In our example, we see that all four measures
