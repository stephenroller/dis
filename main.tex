...
Distributional Inclusion. After learning the model's parameters from data,
we used the hyperplane to select which distributional features were {\em most}
selected by the classifier. We did this by comparing the model's learned
hyperplane to the {\em context vectors} obtained in the Singular Value
