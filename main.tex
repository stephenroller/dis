...
assume there is some form of {\em composition function} where the relation
is applied to the word? Mathematically, we might say that instead of modeling
{\tt nsubj\_dog} as a vector, we will model it as:
\begin{equation*}
  \vec{ {\tt nsubj\_dog} } = {\tt nsubj}(\vec{dog})
\end{equation*}
