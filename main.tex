...
task in Natural Language Processing. One of the original papers detailing
the challenge describes it as ``recognizing, given two text fragments, whether
the meaning of one text can be inferred (entailed) from the other.''
