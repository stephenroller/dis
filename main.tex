...
also covers much more interesting cases, like this one from one data set:
\begin{quote}
  [She] stood stock-still, {\bf waiting} for the first tiny gleam from the scout craft to appear in the darkness of the wormhole.
\end{quote}
