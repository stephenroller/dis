...
Lexsub as the best means of capturing {\em synonymy} into our thesis. Until
now, we have assumed that words are mononymous, or that they have only one
meaning. However, words like ``bright'' have multiple meanings, which change
depending on context, as in ``bright girl'' and ``bright lamp.'' This is
called {\em polysemy}, and is a major issue in distributional semantics.
