...
Semantics. We emphasize 

In Lexical Relationship Detection, we try to specifically identify
whether two words exhibit specific lexical relationships, like hypernymy (is-a
relationships) or meronymy (has-a relationships). In particular, we will
present two models which can learn to predict hypernymy and general lexical
entailment, and
