...
Vector Space Models (VSMs) of language; they have also become immensely
popular in the neural network literature with the name {\em word embeddings}.
...
low dimensional VSMs have also become remarkably popular in the neural network
literature, and the most popular algorithms for computing word embeddings, like
Skip-Gram Negative Sampling (SGNS) \cite{mikolov:2013:iclr} and GloVe
\cite{pennington:2014:emnlp} can be viewed explicitly as form of dimensionality
reduction \cite{levy:2014:nips,levy:2015:tacl}.
