...
false,\footnote{Consider ``\#The {\em animal} barked loudly at its bowl of {\em animal}
...
Increasingly, as it became obvious that unsupervised measures did not work as well
as hoped, the community began working on entailment detection as
...
reported scores in the high 90s, others later realized this was due to
...
since it adds yet another layer of possible in sentence meaning.
