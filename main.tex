...
representation of the sentence \cite{kamp:2013:discourse}.



, starting with atomic representations for
words, and building more complex representations, often by modeling grammatical
structures as lambda expressions that return FOL form
