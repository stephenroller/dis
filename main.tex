...
In the previous sections, we saw that the Asym classifier is able to improve
upon both a model previously proposed in the literature \cite{baroni:2011:gems}.
