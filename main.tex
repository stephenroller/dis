...
WordNet features, or the more sophisticated Asym classifier. We also see that
the WordNet features outperform Asym, though this is not suprising, since
WordNet is a rich resource containing many gold standard entailments. However,
we also notice that the classifier which combines Asym with the Concat
classifier performs substantially better than Asym does by itself, indicating
there may be a
