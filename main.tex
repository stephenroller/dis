...
FOL formulae are built iteratively, starting with atomic representations for
words, and building more complex representations based on the grammatical
structure of the sentence \cite{kamp:2013:discourse}.
