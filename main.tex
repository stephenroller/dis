...
The core notion is that words can be understood by the {\em contexts} in which
the word appears, an idea that has a long history in the semantics and
philosophical literature \cite{wittgenstein:1953:pi,harris:1954:word,firth:1957:la}
...
Azawakh from other {dog} populations near base
