...
\subsubsection{Wider contexts in Lexical Substitution}
...
to fill-in-the-blank in the following two sentences:
...
verb: its subject should be {\em dog} and its object should be {\em ball}.
