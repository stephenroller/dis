...
models on three data sets: SemEval07, the original LexSub data set
...
measures whether our best substitute\footnote{Excluding any words sharing the
same lemma as the target} is contained within the gold set of substitutes
...
Table~\ref{tab:lexsub} contains results for all measures across all
