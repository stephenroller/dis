...
First Order Logical formulas \cite{needcite}. Then, by assuming entity coreference
\footnote{Human annotators
tend to view entities appearing in both sentences as {\em coreferent}, e.g.,
``The airplane lands {\em contradicts} An airplane crashes;'' although these
two sentences are not strictly contradictory, annotators assume
airplane is the same in both sentences, and conclude contradiction.}
