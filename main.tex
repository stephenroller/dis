...
used. Figure~\ref{fig:hyperparms}b shows the performance comparing the use
of a Logistic Regression classifier with a Linear SVM, Polynomial SVM, and an
RBF SVM.

that syntactic distributional spaces performed better
than any BoW space on multiple datasets and with multiple models. This is
consistent with our findings in Section~\ref{sec:asym}, which found that
narrower windows.
