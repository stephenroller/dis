...
lexical substitute. As a introduction point for our measure, we review the
work of \newcite{melamud:2015:vsm}, which introduced several measures for
word similarity in context: namely \balAddCos and \addCos.
