...
from the {\em words} in syntactic distributional spaces? That is, can we
assume there is some form of {\em composition function} which combines how a
word behaves when standing in a particular syntactic relation with another?
...
subject position. How could this work? One possibility would be to use vector
concatenation, treating the relation and the word as separate components,
