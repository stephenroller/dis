...
\begin{scriptsize}
\begin{alltt}
and manipulate the \structure{dog} 's lips and
       as a clever \structure{dog} ; two to
a reputation among \structure{dog} trainers of having
    also among the \structure{dog} breeds most likely
 the very earliest \structure{dog} shows and kennel
Azawakh from other \structure{dog} populations near base
        as a guard \structure{dog} and to hunt
   the mechanic 's \structure{dog} began to howl
\end{alltt}
\end{scriptsize}
\end{minipage}\qquad
\begin{minipage}{3cm}
