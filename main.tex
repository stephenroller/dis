...
like compositional distributional semantics \cite{needcite}
...
step. Unfortunately, tensor factorization can be very difficult \cite{needcite},
and there is no such convenient canonical factorization for tensors, as the
SVD is for matrices.
