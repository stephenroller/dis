...
levels of the Vauquois Triangle \cite{needcite}, like Part-of-Speech tagging
\cite{needcite} and Parsing \cite{needcite}.  Even difficult semantics tasks,
...
and Coreference Resolution \cite{needcite}, have made significant progress.
...
about passages NEEDCITE, and Recognizing Textual Entailment (RTE), where
computers must decide whether a hypothesis utterance logically follows from a
given text \cite{marelli:2014:semeval,bowman:2015:emnlp,beltagy:2016:cl}.
...
resources
\cite{marelli:2014:semeval,lai:2014:semeval,beltagy:2014:semeval,beltagy:2016:cl}.
...
between different lexical items, though countless other resources also exist
...
incomplete, and represent one weak point in Natural Language Understanding
