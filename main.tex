...
and then focused research on mostly the ranking task \cite{NEEDCITE}. Today,
many have begun returning to the generation-and-ranking task \cite{NEEDCITE},
but opting to avoid lexical resources like WordNet.

Since then, various methods have been used to improve scores on the candidate
ranking task, with most of the interest being in 
