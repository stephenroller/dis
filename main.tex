...
construction than raw co-occurrence counts \cite{turney:2010:jair}.
...
additionally ignores those which occur less often than chance
\cite{bullinaria:2007:brm}.  Other transformations, like conditional
probability \cite{deerwester:1990:jsis,blei:2003:jmlr}, and Softplus
...
Interestingly, the recent, popular Skip-Gram Negative Sampling (SGNS) algorithm
\cite{mikolov:2013:iclr} can also be viewed as a form of dimensionality
reduction \cite{levy:2014:nips}.
