...
\begin{quote}
``Lexical entailment is a semantic relation
that holds between lexical elements when the meaning of one element can
be inferred from the meaning of the other.'' \cite{shnarch:2008:thesis}
\end{quote}
