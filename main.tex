...
this task. Finally, we dicuss the Lexical Entailment and Lexical Substitution
tasks, which we view as strong, albeit incomplete, proxies for the sorts of
lexical semantics necessary for RTE.
