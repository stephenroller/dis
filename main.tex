...
Distributional Semantics is a powerful tool for automatically inducing
semantic representations for lexical items \cite{turney:2010:jair,erk:2012:llc}.

\begin{figure}
\centering
\subfloat[a]{\begin{scriptsize}\begin{alltt}

           mouth and manipulate the \structure{dog} 's lips and vocal
                  smart as a clever \structure{dog} ; two to three
             has a reputation among \structure{dog} trainers of having a
                 are also among the \structure{dog} breeds most likely to
               of the very earliest \structure{dog} shows and The Kennel
             the Azawakh from other \structure{dog} populations near the base
                   there as a guard \structure{dog} and to hunt gazelle
              after the mechanic 's \structure{dog} began to howl so
                 also make them the \structure{dog} of choice for animal
\end{alltt}\end{scriptsize}}
\subfloat[b]{\includegraphics[width=0.3\textwidth]{figures/vectors}}
\caption{Contexts in which the word {\em dog} appears, and cartoon drawing
