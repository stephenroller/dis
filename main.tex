...
\begin{table}
  ...
  \begin{tabular}{|ll|c|}
    ...
    \hline
    Random Baseline           &     -   & .50\\
    \cite{baroni:2011:gems}   & Window 2 & .81\\
    \cite{roller:2014:coling} & Window 2 & {\bf .85}\\
    \cite{baroni:2011:gems}   & Sentence & .78\\
    \cite{roller:2014:coling} & Sentence & .82
    \hline\hline
    \multicolumn{3}{c|}{ {\bf BLESS}}\\
    \hline
    Always guess {\em no-relation} & - & .46\\
    \cite{baroni:2011:gems}   & Window 2 & .76\\
    \cite{roller:2014:coling} & Window 2 & {\bf .84}\\
    \cite{baroni:2011:gems}   & Sentence & .73\\
    \cite{roller:2014:coling} & Sentence & .80
    \hline
  \end{tabular}
  \end{center}
