...
also covers much more interesting or narrow cases, for example,
\begin{quote}
  ``Tara stood stock-still, {\bf waiting} for the first tiny gleam from the
  scout craft to appear in the darkness of the wormhole,''
\end{quote}
Where human annotators considered {\em anticipating} and {\em lingering} to be
the best possible substitutes, neither of which 



\newcite{kremer:2014:eacl} found
that only 9\% of lexical substitutes were direct synonyms in WordNet

For example, \newcite{kremer:2014:eacl}
point an interesting 
...
substitution, given its ability to measure the graded levels of similarity
