...
Interestingly, to our knowledge, only one paper treated the problem as a
supervised classification task before 2014: although many had tried using
lexical pattern matching techniques, like Hearst patterns
\cite{hearst:1992:coling,snow:2004:nips}, only \newcite{baroni:2011:gems} had
tried supervised classification; even then, their model was only proposed as
a baseline model in early analysis of their new data set, BLESS.

Around the same time

To answer this e consider how the problem could be recast as a
