...
section, we address this inconsistency, and propose a new Multiprototype
classification model for hypernymy detection.

This is curious,
given that the model of \newcite{baroni:2011:gems} contains these Concat
vectors, but 
of \newcite{baroni:2011:gems} also uses these LHS and RHS features (called
Concat features from now on), but with a polynomial SVM instead of a linear
classifier. Interestingly, we can also directly compare
