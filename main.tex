...
performance in other non-hypernymy relationships.
...
simply use the H-feature detector procedure to provide
...
Equations~\ref{eqn:pic}~and~\ref{eqn:npic}. Although polysemy is not a significant
issue in the SICK dataset, we believe the additional information may benefit
the final lexical entailment classifier.
