...
classification problem, and proposed Asym, a simple supervised model
that is inherent asymmetric. At its core, the model is inspired by the famous
result of \newcite{mikolov:2013:iclr}, who observed that vector subtraction
can be used to perform some kinds of analogical reasoning:
\begin{equation*}
  {\tt king} - {\tt man} + {\tt woman} \approx {\tt queen}.
\end{equation*}
